...
huggingface-cli download unsloth/Qwen3.6-27B-GGUF Qwen3.6-27B-Q5_K_S.gguf \
...
huggingface-cli download spiritbuun/Qwen3.6-27B-DFlash-GGUF Qwen3.6-27B-DFlash-Q4_K_M.gguf \
  --local-dir "${PRECISION_DIR}" \
  --local-dir-use-symlinks False
